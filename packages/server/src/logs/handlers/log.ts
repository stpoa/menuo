...
const prepareLogs = (eventData: {
  ...
  return eventData.logEvents.map(
    (event: { message: string; id: any; timestamp: any }) => {
...
export const handler = (
  ...
  return sendLine(
    prepareLogs(parseEventGzipData(event as any) as any) as any,
    callback,
  )
}
